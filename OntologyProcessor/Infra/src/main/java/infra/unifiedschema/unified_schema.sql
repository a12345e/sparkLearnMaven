...
PARTITIONED BY (
  ...
  relation      STRING COMMENT 'relation between the relating object and related object. The relation is a concatenation of <directed relation name>_<period_type>_<'related' <category><type><subtype><format>>_<'relating' <category><type><subtype><format>>',
